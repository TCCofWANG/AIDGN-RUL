...
"""
#Copyright (c) 2026 Andrew Lin
# All rights reserved.
# Contact Information:
# Author: Andrew Lin
# Email: alin49@mcmaster.ca
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', default=True, type=str2bool,  help='load checkpoint or not')
    parser.add_argument('--save_test', default=False, type=str2bool,  help='Save pred and target when testing')
    parser.add_argument('--save_path', default='exp0', help='exp0 If path is None, exp_id add 1 automatically:if train, it wiil be useful')
    ...
    parser.add_argument('--ablation_mode', default='linear', type=str, help='[linear, exponential, weiner_process, gamma_process, feature_mean, pca, pe]')
    parser.add_argument('--AATE_dim', default = 16, type=int, help='AATE dimension')
    ...
    parser.add_argument('--d_ff', default=512, type=int, help='embedding dimension ')
    ...
    if args.task == 'normal':
        if args.DA == True:
            ...
            if args.dataset_name =="N_CMAPSS":
                data_id = args.Data_id_N_CMAPSS
            else : data_id = args.Data_id_CMAPSS
            hparams_class = get_configs(args.dataset_name, data_id)
