...
if __name__ == '__main__':
    ...
    parser.add_argument ( '--Data_id_CMAPSS' , default = "FD001" , type = str , help = 'CMAPSS subset [FD001,FD002, FD003, FD004] for train' )
    parser.add_argument ( '--Data_id_CMAPSS_test' , default = "FD001" , type = str , help = 'CMAPSS subset [FD001,FD002, FD003, FD004] for test' )
    ...
    if args.task == 'normal':
        if args.DA == True:
            ...
            for model_name in model_names :
                ...
                args.Data_id_CMAPSS_test = args.Data_id_CMAPSS
