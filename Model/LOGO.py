...
class LOGO_model(nn.Module):
    def __init__(self, args, input_feature):
        ...
        input_dimension = args.patch_size
        ...
        self.TD = Bi_LSTM_Standard(input_dimension*3, 3*args.hidden_dim, None)

        self.graph_attn_blk = Graph_atten_block(self.num_nodes, self.num_nodes)

        self.fc = nn.Sequential(OrderedDict([
            ('fc1', nn.Linear(3* args.hidden_dim * self.num_patch*self.num_nodes, 16)),
    ...
    def forward(self, X, idx=None, gamma = 1):
