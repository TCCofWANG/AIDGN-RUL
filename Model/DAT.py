...
from layers.DAT_EncDec import Encoder, EncoderLayer, IEncoderLayer, IEncoder
from layers.DAT_SelfAttention import FullAttention, AttentionLayer, DegradationAttention, M_FullGaussianAttention
...
class DAT(nn.Module):
    ...
    def __init__(self, sequence_len, feature_len, hidden_dim,
                 fc_layer_dim, rnn_num_layers, fc_activation,fc_dropout=0.1,
            ...
            [
                IEncoderLayer(
                    AttentionLayer(
                        ...
                        DegradationAttention(attention_dropout=fc_dropout, output_attention=self.output_attention),
